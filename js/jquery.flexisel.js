    ...
    *******************************/
    var methods = {
      ...
      appendHTML: function () {
        ...
        $(
          "<div class='nbs-flexisel-nav-left'><i class='fa fa-angle-left'></i></div><div class='nbs-flexisel-nav-right'><i class='fa fa-angle-right'></i></div>"
      ...
      *******************************/
      setResponsiveEvents: function () {
        ...
        if (settings.enableResponsiveBreakpoints) {
          var largestCustom = responsivePoints[responsivePoints.length -
            1].changePoint; // sorted array 
      ...
      *******************************/
      scrollRight: function () {
        ...
        var objPosition = (object.position().left + ((totalItems -
          itemsVisible) * itemsWidth) - innerWidth);
