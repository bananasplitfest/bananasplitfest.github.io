...
(function (factory) {
    ...
    init: function (options) {
      ...
      function initElement($select) {
        ...
        $input.on("click focus", function (e) {
          ...
          $(".dropdownjs > ul > li").attr("tabindex", -1);
          $(".dropdownjs > input").not($(this)).removeClass("focus")
            .blur();
          $(".dropdownjs > ul > li").not(".dropdownjs-add").attr(
            "tabindex", 0);
        ...
        $(document).on("click", function (e) {
          ...
          if ($(e.target).parents(".dropdownjs-add").length || $(e.target)
            .is(".dropdownjs-add")) return;
    ...
    _select: function ($dropdown, $target) {
      ...
      if (multi) {
        ...
        $target.each(function () {
          var $selected = $select.find("[value=\"" + $(this).attr(
            "value") + "\"]");
  ...
  $.fn.dropdown = function (params) {
    if (methods[params]) {
      return methods[params].apply(this, Array.prototype.slice.call(
        arguments, 1));
